...
const InvestmentServices = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 text-black dark:text-white transition-colors duration-500 py-60">
      ...
      <div className="grid grid-cols-5 gap-4 py-20 max-w-6xl mx-auto">
        {services.map((service) => (
          <div
            key={service.id}
            className="relative flex flex-col items-center rounded-2xl py-40 shadow-lg bg-gray-100 dark:bg-gray-800 overflow-hidden group transition-colors duration-500"
          >
